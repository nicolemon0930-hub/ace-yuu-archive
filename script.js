...
function initDOM() {
    ...
    form.onsubmit = function (e) {
        ...
        const data = {
            ...
            createdAt: editingId
                ? (archive.find(function (a) { return a.id === editingId; }) || {}).createdAt
                : new Date().toISOString()
        };

        if (editingId) {
            var idx = archive.findIndex(function (a) { return a.id === editingId; });
    ...
    btnExport.onclick = function () {
        ...
        try {
            ...
            prompt("请手动复制以下 JSON 文本并保存：", json);
        }
    };
